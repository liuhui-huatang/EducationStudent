 ...
 */
public class ClassAnnouncementActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener{
    ...
    public void initDatas(){
        ...
        waitDialog.show();
        teacherInternet.getClassGGDatas(String.valueOf(pageNum));
    }
    public void initViews(){
        ...
        classAnnouncementAdapter = new ClassAnnouncementAdapter(this,announcementEntities);
   ...
   public AdapterView.OnItemClickListener announceClicer = new AdapterView.OnItemClickListener() {
       ...
       public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
           ...
           Intent intent = new Intent(ClassAnnouncementActivity.this,AnnouncementDetailsActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 400:
                    ...
                    ToastUtil.showToast("服务器连接失败",ClassAnnouncementActivity.this);
                    break;
                case 200:
                    //网络请求成功，解析数据
                    if(waitDialog!=null){
                ...
                case 300:
                    ...
                    ToastUtil.showToast("数据异常",ClassAnnouncementActivity.this);
                    break;
            }
        }
    };

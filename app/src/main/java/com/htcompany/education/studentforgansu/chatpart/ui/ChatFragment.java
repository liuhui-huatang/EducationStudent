...
import com.htcompany.education.studentforgansu.chatpart.Constant;
...
//            startActivityForResult(intent, REQUEST_CODE_SELECT_VIDEO);
    ...
    protected void startVoiceCall() {
        if (!EMClient.getInstance().isConnected()) {
            ...
            startActivity(new Intent(getActivity(), VoiceCallActivity.class).putExtra("username",toChatUsername).putExtra("isComingCall", false).putExtra("hznam",username));

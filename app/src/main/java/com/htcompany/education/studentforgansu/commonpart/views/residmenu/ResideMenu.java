package com.htcompany.education.studentforgansu.commonpart.views.residmenu;
...
public class ResideMenu extends FrameLayout {
    ...
    private View scrollViewLeftMenu;//左侧菜单view
    private View scrollViewRightMenu;//右侧裁断view
    ...
    public void openMenu(int direction) {
        ...
        AnimatorSet menuactivity = buildScaleUpAnimation(scrollViewMenu, 1.0f, 1.0f);
        AnimatorSet scaleUp_shadow = buildScaleUpAnimation(scrollViewMenu, 1.0f, 1.0f);
        menuactivity.playTogether(scaleUp_shadow);
        menuactivity.playTogether(alpha_menu);
        menuactivity.start();
    }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (pressedState == PRESSED_DOWN) {
                    ...
                    if (mUse3D) {
                        ...
                        //设置缩放
                        ViewHelper.setScaleX(scrollViewMenu, (1 - targetScale) * 2.0f);
                        ViewHelper.setScaleY(scrollViewMenu, (1 - targetScale) * 2.0f);

package com.htcompany.education.studentforgansu.commonpart.views.classtable;
...
import com.htcompany.education.studentforgansu.mainpart.dailogs.ClassTableDetialsDailog;
...
//            R.drawable.select_label_yi, R.drawable.select_label_wuw};
    public static int colors[] = {R.color.ic_coure_san,
            R.color.ic_coure_er, R.color.ic_coure_si,
            R.color.ic_coure_wu, R.color.ic_coure_liu,
            R.color.ic_coure_qi, R.color.ic_coure_ba,
            R.color.ic_coure_jiu, R.color.ic_coure_yier,
            R.color.ic_coure_yier, R.color.ic_coure_yiwu,
            R.color.ic_coure_yis, R.color.ic_coure_yiliu,
            R.color.ic_coure_yi, R.color.ic_coure_wuw};
     ...
     * 星期高度
     */
    private final static int TimeTableWeekNameHeight = 50;//星期高度
    /**
     *  第一行的星期显示
     */
    ...
    private String[] weekname = {"星期一", "星期二", "星期三", "星期四", "星期五", "星期六", "星期日"};
    ...
    private void initView() {
        ...
        mHorizontalWeekLayout = new LinearLayout(getContext());//第一行星期显示
        mHorizontalWeekLayout.setOrientation(HORIZONTAL);

        mVerticalWeekLaout = new LinearLayout(getContext());//课程格子
        ...
        for (int i = 0; i <= WEEKNUM; i++) {
            switch (i) {
                ...
                case 7:
                    ...
                    mWeekName.setTextSize(12);
                    mWeekName.setBackgroundColor(getResources().getColor(R.color.week_bg));
                    mWeekName.setTextColor(getResources().getColor(R.color.week_tv));
...
//                    Toast.makeText(getContext(), "星期" + week + "第" + (start + num) + "节", Toast.LENGTH_LONG).show();
    ...
    private View getMode(final TimeTableModel model) {
        ...
        mTimeTableView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //展示课程详情，起一个dailog,或者跳转界面
//                Toast.makeText(getContext(), model.getName() + "@" + model.getClassroom(), Toast.LENGTH_LONG).show();
                ClassTableDetialsDailog classTableDetialsDailog = new ClassTableDetialsDailog(getContext(),model);
                classTableDetialsDailog.show();
            }
        });

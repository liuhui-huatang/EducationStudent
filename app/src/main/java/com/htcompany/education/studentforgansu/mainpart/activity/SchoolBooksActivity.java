...
import com.htcompany.education.studentforgansu.mainpart.adapter.BooksManageAdapter;
 ...
 */
public class SchoolBooksActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener {
    private TextView title, right_btn_tv;
    private RelativeLayout reback_btn, right_text_btn;
    private XListView booksmanage_lv;
    private BooksManageAdapter manageAdapter;
    ...
    public void initDatas(){
        ...
        waitDialog.show();
        booksInternet.getBooks_LISTDatas(String.valueOf(pageNum),bookName,typeId);
    }
    public void initViews() {
        ...
        manageAdapter = new BooksManageAdapter(this,bookEntities);
    ...
    public AdapterView.OnItemClickListener bookManageClicer = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            //调到图书详情界面
            BookEntity entity = (BookEntity) manageAdapter.getItem(position-1);
            intent = new Intent(SchoolBooksActivity.this, BooksDetiasActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.right_text_btn:
                //调到图书分类界面
                intent = new Intent(SchoolBooksActivity.this, BooksTypesActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 400:
                    ...
                    ToastUtil.showToast("连接超时",SchoolBooksActivity.this);
                    break;
                case 200:
                    if(waitDialog!=null){
                        waitDialog.dismiss();
                    }
                    List<BookEntity> datas = booksPersener.parseSchoolbooksData((String)msg.obj);
                ...
                case 300:
                    ...
                    ToastUtil.showToast("数据异常",SchoolBooksActivity.this);
                    break;
            }
        }
    };
    public void setAdapterValues(List<BookEntity> datas){
        if(pageNum==1) {

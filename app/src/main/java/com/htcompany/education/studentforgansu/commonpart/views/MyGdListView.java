 ...
 */
public class MyGdListView extends ListView{
    public MyGdListView(Context context) {
        super(context);
    }

    public MyGdListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyGdListView(Context context, AttributeSet attrs, int defStyleAttr) {

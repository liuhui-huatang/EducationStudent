 ...
 */
public class AlreadyApplyJobsActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener{
    ...
    public void initDatas(){
        ...
        waitDialog.show();
        companyInternet.getCompany_YBMGWMsg(searchername,String.valueOf(pageNum));
    }
    ...
    public AdapterView.OnItemClickListener commpanyClicer = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(AlreadyApplyJobsActivity.this,CommpanyInformationDetailsActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 300:
                    ...
                    ToastUtil.showToast("数据异常",AlreadyApplyJobsActivity.this);
                    break;
                case 400:
                    if(waitDialog!=null){
                        waitDialog.dismiss();
                    }
                    ToastUtil.showToast("服务器连接失败",AlreadyApplyJobsActivity.this);
                    break;
            }
        }
    };
